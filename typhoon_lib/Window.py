...
gi.require_version('Gio', '2.0')  # Explicitly require Gio 2.0
...
class Window(Gtk.Window):
    ...
    def finish_initializing(self, builder):
        ...
        try:
            ...
            logger.warning("AppIndicator support is not available.")

    def on_mnu_contents_activate(self, widget, data=None):
        show_uri(self, f"ghelp:{get_help_uri()}")
    ...
    def on_preferences_changed(self, settings, key, data=None):
        logger.debug(f'Preference changed: {key} = {settings.get_value(key)}')
